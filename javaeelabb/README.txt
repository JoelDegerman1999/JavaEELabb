...
a persistence unit "javaeelabbPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "javaeelabb\pom.xml":
...
artifact ("javaeelabb.war") is already built. You can build
